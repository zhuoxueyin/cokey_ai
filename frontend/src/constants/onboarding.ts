...
export const BUILTIN_PROFILE_OPTIONS = [
  { value: 'apiyi.gpt-image-2-all.text_to_image', label: 'APIYI all 文生图', mode: 'text_to_image' },
  { value: 'apiyi.gpt-image-2-all.image_to_image', label: 'APIYI all 图生图', mode: 'image_to_image' },
  { value: 'apiyi.gpt-image-2-vip.text_to_image', label: 'APIYI vip 文生图', mode: 'text_to_image' },
  { value: 'apiyi.gpt-image-2-vip.image_to_image', label: 'APIYI vip 图生图', mode: 'image_to_image' },
  { value: 'weelinking.openai-image.text_to_image', label: 'Weelink 文生图', mode: 'text_to_image' },
  { value: 'weelinking.openai-image.image_to_image', label: 'Weelink 图生图', mode: 'image_to_image' },
  { value: 'openai.chat.text_chat', label: 'OpenAI 生文', mode: 'text_chat' },
  { value: 'volcengine.video.text_to_video', label: '火山 多模态视频（文/混合）', mode: 'text_to_video' },
  { value: 'volcengine.video.image_to_video', label: '火山 多模态视频（含参考素材）', mode: 'image_to_video' },
]
